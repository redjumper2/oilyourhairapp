...
test-website:
	...
	@echo ""
	@echo "⚠️  Make sure to start the required modules first:"
	@echo "  cd products_module && make run    # Terminal 1 - Products API on :9091"
	@echo "  cd auth_module && make run        # Terminal 2 - Auth API on :9090"
	@echo ""
